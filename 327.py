...
# class Solution(object):
    ...
    #     size = len(nums)
    #     memo = [[0 for i in range(size)] for j in range(size)] 
    #     count = 0
    ...
    #             sumxy =  memo[i][i+l-1]+ nums[i+l]
    #             memo[i][i+l] = sumxy
    #             # print "i="+str(i),"l="+str(l),sumxy,memo[i][i+l-1]
    #             if sumxy <=upper and sumxy >=lower: 
    #                 count += 1
    ...
    #     self.A = nums
    #     self.count = 0
    #     self.DivCoq(0,len(nums)-1) 
    #     return self.count
    # @memorizer
    # def DivCoq(self,st,ed):
    #     if st>ed:
    #         return 0
    #     elif st==ed:
    #         s = self.A[st]
    #     else:
    #         s = self.DivCoq(st,(st+ed)/2) + self.DivCoq((st+ed)/2+1,ed)
    #     if s<=self.u and s>=self.l:
    #         self.count+=1
    #     return s
    ...
    #     for i in range(size):
    #         memo[str(i)+"-"+str(0)]=nums[i]
    #         if nums[i]<=upper and nums[i]>=lower:
    #             count += 1

    #     for l in range(1,size):
    #         for i in range(0,size-l):
    #             sumxy =  memo[str(i)+"-"+str(l-1)]+ nums[i+l]
    #             memo[str(i)+"-"+str(l)] = sumxy
    #             del memo[str(i)+"-"+str(l-1)]
    #             # print "i="+str(i),"l="+str(l),sumxy,memo[i][i+l-1]
    #             if sumxy <=upper and sumxy >=lower: 
    #                 count += 1
